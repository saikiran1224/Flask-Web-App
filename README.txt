...
----------------------------------------------------------------
Welcome to Pega Platform 7.4 Personal Edition.
...
Your kit contains the following installation and educational components:
	...
	*  Pega Platform 7.4 Personal Edition software to support the Windows 64 bit operating system
...
The kit contains the following files and folders:
	...
	* 'jdk1.8.0_121' folder
	* 'install.bat' file
	* '74ThirdPartyLicense.pdf' document
	* 'PRPC_PE.jar' file
	* 'README.txt' file
...
Installing Personal Edition
	...
	To install Personal Edition, double-click the install.bat Windows Batch file. Directions can be found on the PDN at https://pdn.pega.com/pega-platform-personal-edition
...
Personal Edition Release Information
	...
	https://pdn.pega.com/pega-platform-personal-edition
